...
contract ShrimpFarmer {
    ...
    function becomeSnailmaster() public {
        ...
        hatcheryShrimp[msg.sender] = SafeMath.sub(
    ...
    function hatchEggs(address ref) public {
        ...
        hatcheryShrimp[msg.sender] = SafeMath.add(
            hatcheryShrimp[msg.sender],
            newShrimp
        );
    ...
    function sellEggs() public {
        ...
        hatcheryShrimp[msg.sender] = SafeMath.mul(
            SafeMath.div(hatcheryShrimp[msg.sender], 3),
            2
        );
        claimedEggs[msg.sender] = 0;
        lastHatch[msg.sender] = now;
